...
import tp4.ejercicio3.model.exceptions.PersonaException;
...
public class Persona {
    ...
    private String dni;
    private Email email;
    private ThirdPhone phone;
    private Concurso concurso;

    public Persona(String name, String lastName, String dni, Email email, ThirdPhone phone, Concurso concurso) throws PersonaException {
