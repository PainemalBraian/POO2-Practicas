...
import tp4.ejercicio3.model.APITHREE;
import tp4.ejercicio3.model.ThirdController;
...
public class RadioCompetition {
    ...
    APITHREE api = new ThirdController();
    ...
    private void guardarInscripcion() {
        ...
        try {
            api.saveInscription(name, lastName, dni, telefono, email, comboBox.getSelectedItem().toString());
    ...
    private void cargarTodosLosConcursos() {
        try {
            List<String> concursos = api.getTodosLosConcursos();
